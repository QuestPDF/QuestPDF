...
namespace QuestPDF.Elements.Text.Items
{
    internal class TextBlockSpan : ITextBlockItem
    {
        ...
        private TextStyle? _spaceCodepointStyle;
        private ushort _spaceCodepoint;

        private ushort SpaceCodepoint
        {
            get
            {
                if (_spaceCodepointStyle == Style)
                {
                    return _spaceCodepoint;
                }

                _spaceCodepointStyle = Style;
                _spaceCodepoint = Style.ToPaint().ToFont().Typeface.GetGlyphs(" ")[0];
