// AUTO-GENERATED on 02/24/2026 08:42:02
...
[UnmanagedCallersOnly(EntryPoint = "questpdf__page_descriptor__size__593af4d7", CallConvs = new[] { typeof(CallConvCdecl) })]
public static void PageDescriptor_Size_593af4d7(IntPtr target, float pageSize_width, float pageSize_height)
{
    var targetObject = UnboxHandle<PageDescriptor>(target);
    
    targetObject.Size(new PageSize(pageSize_width, pageSize_height));
}
...
[UnmanagedCallersOnly(EntryPoint = "questpdf__page_descriptor__min_size__8216ba5f", CallConvs = new[] { typeof(CallConvCdecl) })]
public static void PageDescriptor_MinSize_8216ba5f(IntPtr target, float pageSize_width, float pageSize_height)
{
    var targetObject = UnboxHandle<PageDescriptor>(target);
    
    targetObject.MinSize(new PageSize(pageSize_width, pageSize_height));
}

[UnmanagedCallersOnly(EntryPoint = "questpdf__page_descriptor__max_size__02a75d07", CallConvs = new[] { typeof(CallConvCdecl) })]
public static void PageDescriptor_MaxSize_02a75d07(IntPtr target, float pageSize_width, float pageSize_height)
{
    var targetObject = UnboxHandle<PageDescriptor>(target);
    
    targetObject.MaxSize(new PageSize(pageSize_width, pageSize_height));
}
...
public static IntPtr Container_DebugArea_a69b9c65(IntPtr parent, IntPtr text, uint color)
{
...
[UnmanagedCallersOnly(EntryPoint = "questpdf__container__image__ccf976d1", CallConvs = new[] { typeof(CallConvCdecl) })]
public static IntPtr Container_Image_ccf976d1(IntPtr parent, IntPtr image)
{
    var targetObject = UnboxHandle<IContainer>(parent);
    FreeHandle(parent);
    var result = targetObject.Image(UnboxHandle<QuestPDF.Infrastructure.Image>(image));
    return BoxHandle(result);
}
...
[UnmanagedCallersOnly(EntryPoint = "questpdf__container__svg__b1de06e3", CallConvs = new[] { typeof(CallConvCdecl) })]
public static IntPtr Container_Svg_b1de06e3(IntPtr parent, IntPtr image)
{
    var targetObject = UnboxHandle<IContainer>(parent);
    FreeHandle(parent);
    var result = targetObject.Svg(UnboxHandle<QuestPDF.Infrastructure.SvgImage>(image));
    return BoxHandle(result);
}
