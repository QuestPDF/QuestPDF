...
2. **Email** — contact [contact@questpdf.com](mailto:contact@questpdf.com) with a description of the issue.
...
- Vulnerabilities in the [QuestPDF](https://github.com/QuestPDF/QuestPDF) library.
...
- The QuestPDF website ([questpdf.com](https://www.questpdf.com)) — please report website issues via email.
